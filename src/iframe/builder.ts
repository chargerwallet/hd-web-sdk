import { Deferred, createDeferred, HardwareErrorCode, ERRORS } from '@chargerwallet/hd-shared';
...
export const init = async (settings: any) => {
  ...
  const existedFrame = document.getElementById('chargerwallet-connect') as HTMLIFrameElement;
  if (existedFrame) {
    ...
    instance.id = 'chargerwallet-connect';
